...
/**
* ----------------
* This test tests sending of differnt certificate expired alarms.
* -----------------
* 
* Tests:
*    1. Check that page is opened clear and correct
*    2. Test certificate expired alarm with warning severity	
*    3. Test certificate expired alarm with minor severity
*    4. Test certificate expired alarm with major severity
*    5. Test certificate expired alarm with critical severity
*    6. Test certificate expired alarm with cleared severity
*    7. Test certificate expired alarm with indeterminate severity
*    
*    Results:
...
public class Test256_Tools_Alarms_Testser_certificate_expired_alarm {
  ...
  public Test256_Tools_Alarms_Testser_certificate_expired_alarm(String browser) {
  ...
  @Test
  public void Tools_Alarms_Testser_sba_certificate_expired_alarm() throws Exception {
	...
	String alarmType   = "Sba Certificate Expired Alarm";
	...
	// Step 2 - test certificate expired alarm with warning severity
	testFuncs.myDebugPrinting("Step 2 - test certificate expired alarm with warning severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Warning", ipSource, description);
	
	// Step 3 - test certificate expired alarm with minor severity
	testFuncs.myDebugPrinting("Step 3 - test certificate expired alarm with minor severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Minor", ipSource, description);
            	
	// Step 4 - test certificate expired alarm with major severity
	testFuncs.myDebugPrinting("Step 4 - test certificate expired alarm with major severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Major", ipSource, description);
	
	// Step 5 - test certificate expired alarm with critical severity
	testFuncs.myDebugPrinting("Step 5 - test certificate expired alarm with critical severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Critical", ipSource, description);

	// Step 6 - test certificate expired alarm with cleared severity
	testFuncs.myDebugPrinting("Step 6 - test certificate expired alarm with cleared severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Cleared", ipSource, description);
	
	// Step 7 - test certificate expired alarm with indeterminate severity
	testFuncs.myDebugPrinting("Step 7 - test certificate expired alarm with indeterminate severity", testVars.logerVars.MAJOR);
