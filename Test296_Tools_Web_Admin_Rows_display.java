...
/**
* ----------------
* This test tests the different display oprions of logs at Web-Admin-Logs menu.
* -----------------
* 
* Tests:
...
public class Test296_Tools_Web_Admin_Rows_display {
  ...
  public Test296_Tools_Web_Admin_Rows_display(String browser) {
