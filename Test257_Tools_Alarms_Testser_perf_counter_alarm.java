...
/**
* ----------------
* This test tests sending of differnt perf counter alarms.
* -----------------
* 
* Tests:
*    1. Check that page is opened clear and correct
*    2. Test perf counter alarm with warning severity	
*    3. Test perf counter alarm with minor severity
*    4. Test perf counter alarm with major severity
*    5. Test perf counter alarm with critical severity
*    6. Test perf counter alarm with cleared severity
*    7. Test perf counter alarm with indeterminate severity
*    
*    Results:
...
public class Test257_Tools_Alarms_Testser_perf_counter_alarm {
  ...
  public Test257_Tools_Alarms_Testser_perf_counter_alarm(String browser) {
  ...
  @Test
  public void Tools_Alarms_Testser_sba_perf_counter_alarm() throws Exception {
	...
	String alarmType   = "Sba Perf Counter Alarm";
	...
	// Step 2 - test perf counter alarm with warning severity
	testFuncs.myDebugPrinting("Step 2 - test perf counter alarm with warning severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Warning", ipSource, description);
	
	// Step 3 - test perf counter alarm with minor severity
	testFuncs.myDebugPrinting("Step 3 - test perf counter alarm with minor severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Minor", ipSource, description);
            	
	// Step 4 - test perf counter alarm with major severity
	testFuncs.myDebugPrinting("Step 4 - test perf counter alarm with major severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Major", ipSource, description);
	
	// Step 5 - test perf counter alarm with critical severity
	testFuncs.myDebugPrinting("Step 5 - test perf counter alarm with critical severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Critical", ipSource, description);

	// Step 6 - test perf counter alarm with cleared severity
	testFuncs.myDebugPrinting("Step 6 - test perf counter alarm with cleared severity", testVars.logerVars.MAJOR);
	sendAlarmViaTester(driver, alarmType, "Cleared", ipSource, description);
	
	// Step 7 - test perf counter alarm with indeterminate severity
	testFuncs.myDebugPrinting("Step 7 - test perf counter alarm with indeterminate severity", testVars.logerVars.MAJOR);
