...
/**
* ----------------
* This test tests a download of logs at Web-Admin-Logs menu.
* -----------------
* 
* Tests:
*    1. Check that page is opened clear and correct
*    2. Try to download the log.txt file
...
public class Test295_Tools_Web_Admin_Logs_download {
  ...
  public Test295_Tools_Web_Admin_Logs_download(String browser) {
  ...
  public void Tools_Web_Admin_Logs_download() throws Exception {
	...
	// Set vars
	String curLogsName = "log.txt";
	String hisLogsName = "logger_";
	...
	// Step 2 - download log.txt
	testFuncs.myDebugPrinting("Step 2 - download log.txt", testVars.logerVars.MAJOR);
